...
public class SpeedGui extends javax.swing.JPanel {
    private JFrame window;

    public SpeedGui(JFrame window) {
        this.window = window;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Meter per Second", "Kilometer per Hour" }));

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Meter per Second", "Kilometer per Hour" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent e){
        ...
        if (to == "Kilometer per Hour"){
            jTextField2.setText(Double.toString(Speed.KilometerPerHour(from,d)));
        }
        else {
            jTextField2.setText(Double.toString(Speed.MeterPerSecond(from, d)));

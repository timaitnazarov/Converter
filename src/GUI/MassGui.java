...
public class MassGui extends javax.swing.JPanel {
    private JFrame window;

    public MassGui(JFrame window) {
        this.window = window;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gram", "Kilogram", "Ton" }));

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gram", "Kilogram", "Ton" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent e){
        ...
        if (to == "Gram"){
            jTextField2.setText(Double.toString(Mass.Gram(from,d)));
        }
        else if(to == "Kilogram") {
            jTextField2.setText(Double.toString(Mass.Kilogram(from, d)));

        }
        else {
            jTextField2.setText(Double.toString(Mass.Ton(from, d)));
